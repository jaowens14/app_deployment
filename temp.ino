...
const char* ssid = "Jayfi - 2.4"; //Enter SSID
const char* password = "MagicTurkey"; //Enter Password
const char* websockets_server_host = "192.168.10.69"; //Enter server adress
...
void setup() {
    Serial.begin(115200);
    delay(5000);
    Serial.println("Well we got this far");
    // Connect to wifi
